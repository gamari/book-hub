...
public class BookController {
    ...
    public String bookDetail(@PathVariable String id, Model model, Principal principal) {
        ...
        if (optBook.isPresent()) {
            ...
            boolean idReadingBook = readingBookService.isBookRegisteredByUser(id, user.getId());
            int numberOfPeopleReading = readingBookService.countReadingBooksByBookId(id);
